...
This specification defines the external behavior of one `aard case` process.  It covers process startup, standard streams, the private Lawyer and Council APIs, records, results, and participant failures.  Multi-case management and participant transport belong to the `adjservices` repository.
