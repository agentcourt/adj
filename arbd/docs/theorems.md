...
| `ArbdProofs.appendSubmittedEvidence_preserves_caseFrameFields` | `Proofs/ProcedureInvariants.lean` |  |  |
| `ArbdProofs.appendSubmittedEvidence_preserves_councilIdsUnique` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.appendSubmittedEvidence_preserves_phaseShape` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.appendSubmittedEvidence_preserves_recordIntegrity` | `Proofs/RecordIntegrity.lean` | medium | Shows that appending one validated submission with an allowed origin preserves record integrity. |
| `ArbdProofs.appendSupplementalMaterials_preserves_answerIntegrity` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.appendSupplementalMaterials_preserves_caseFrameFields` | `Proofs/ProcedureInvariants.lean` |  |  |
...
| `ArbdProofs.checkReplayCertificate_ok_meritsOfferChronology` | `Proofs/CertificateFacts.lean` | high | Shows that each merits offer in an accepted certificate referred to evidence available in the filing's source state. |
| `ArbdProofs.checkReplayCertificate_ok_reachable` | `Proofs/Replay.lean` | high | Shows that an accepted certificate claims a reachable AARD state. |
| `ArbdProofs.checkReplayCertificate_ok_recordIntegrity` | `Proofs/CertificateFacts.lean` | high | Shows that an accepted certificate's final state has record integrity and the initialized evidence catalog. |
| `ArbdProofs.checkReplayCertificate_ok_runInvariant` | `Proofs/CertificateFacts.lean` | high | Derives the complete initialized-run invariant from certificate acceptance. |
| `ArbdProofs.checkReplayCertificate_ok_stepReachableFrom` | `Proofs/Replay.lean` | medium | Produces an initialized source state and a successful public-step path to the accepted claimed state. |
| `ArbdProofs.checkReplayCertificate_status_closed_facts` | `Proofs/CertificateFacts.lean` | high | Packages exact replay, authority, chronology, reachability, record integrity, fixed catalog, terminal closure, and replayed answer pairs for an accepted closed certificate. |
| `ArbdProofs.checkReplayCertificate_status_failed_facts` | `Proofs/CertificateFacts.lean` | high | Packages exact replay, authority, chronology, reachability, record integrity, fixed catalog, terminal failure, and the replayed failure record for an accepted failed certificate. |
...
| `ArbdProofs.continueDeliberation_preserves_phaseShape` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.continueDeliberation_preserves_phaseShapeInvariant` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.continueDeliberation_preserves_recordIntegrity_and_catalog` | `Proofs/RecordIntegrity.lean` |  |  |
| `ArbdProofs.councilIdsUnique_of_member_ids_eq` | `Proofs/ProcedureInvariants.lean` |  |  |
| `ArbdProofs.councilMemberIdentities_map_preserving_identity` | `Proofs/ProcedureInvariants.lean` |  |  |
| `ArbdProofs.councilMemberIds_map_preserving_ids` | `Proofs/ProcedureInvariants.lean` |  |  |
| `ArbdProofs.currentOpportunity_exists_of_not_none` | `Proofs/Progress.lean` |  |  |
| `ArbdProofs.currentOpportunity_ok_implies_next` | `Proofs/OpportunityAgreement.lean` | medium | Connects successful current-opportunity selection to the public next-opportunity result. |
...
| `ArbdProofs.failOpportunity_preserves_recordIntegrity_and_catalog` | `Proofs/RecordIntegrity.lean` |  |  |
...
| `ArbdProofs.initializeCase_establishes_frame` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.initializeCase_establishes_phaseShape` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.initializeCase_establishes_procedureInvariant` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.initializeCase_establishes_recordIntegrity` | `Proofs/RecordIntegrity.lean` |  |  |
| `ArbdProofs.initializeCase_establishes_recordIntegrity_and_catalog` | `Proofs/RecordIntegrity.lean` | high | Shows that successful initialization establishes record integrity and copies the request evidence catalog unchanged. |
| `ArbdProofs.initializeCase_establishes_runInvariant` | `Proofs/StepPreservation.lean` | high | Shows that successful initialization establishes the procedural, record, answer, council, and fixed-frame invariants. |
| `ArbdProofs.initializeCase_preserves_evidenceCatalog` | `Proofs/RecordIntegrity.lean` |  |  |
| `ArbdProofs.initializeCase_rejects_duplicate_member_ids` | `Proofs/InitializeCase.lean` |  |  |
| `ArbdProofs.initializeCase_requires_matching_council_size` | `Proofs/InitializeCase.lean` |  |  |
| `ArbdProofs.initializeCase_reseats_every_council_member` | `Proofs/InitializeCase.lean` |  |  |
| `ArbdProofs.initializeCase_result` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.initializeCase_sets_core_case_fields` | `Proofs/InitializeCase.lean` |  |  |
| `ArbdProofs.initializedRunInvariant_of_components` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.initializedRun_reachable_invariant` | `Proofs/StepPreservation.lean` | high | Shows that every state reachable from successful initialization satisfies the complete initialized-run invariant. |
...
| `ArbdProofs.recordMeritsSubmission_with_materials_record_details` | `Proofs/RecordIntegrity.lean` |  |  |
| `ArbdProofs.remainingDeliberationSteps_le_council_size` | `Proofs/Progress.lean` |  |  |
| `ArbdProofs.remainingMeritsSteps_le_eight` | `Proofs/Progress.lean` |  |  |
...
| `ArbdProofs.replaySteps_success_stepReachableFrom` | `Proofs/Replay.lean` | medium | Turns a successful action replay into a public-step reachability path. |
| `ArbdProofs.replaySteps_success_stepReachableFrom_of_base` | `Proofs/Replay.lean` |  |  |
| `ArbdProofs.requireOpportunityAuthority_ok_implies_eq` | `Proofs/OpportunityAgreement.lean` | medium | Shows that successful authority comparison establishes exact equality with the expected authority. |
| `ArbdProofs.sample_closed_certificate_answer_pairs` | `Proofs/CertificateExamples.lean` | high | Computes the closed example's member answers as 72, 55, and 18. |
| `ArbdProofs.sample_closed_certificate_check` | `Proofs/CertificateExamples.lean` | high | Proves that the concrete closed certificate is accepted by `checkReplayCertificate`. |
| `ArbdProofs.sample_closed_certificate_check_bool` | `Proofs/CertificateExamples.lean` | medium | Evaluates the concrete closed certificate check to true. |
| `ArbdProofs.sample_closed_certificate_facts` | `Proofs/CertificateExamples.lean` | high | Instantiates the complete closed certificate fact package for the concrete answer run. |
| `ArbdProofs.sample_closed_certificate_status` | `Proofs/CertificateExamples.lean` | medium | Shows that the concrete answer run ends with closed status and phase. |
| `ArbdProofs.sample_failed_certificate_check` | `Proofs/CertificateExamples.lean` | high | Proves that the concrete failed certificate is accepted by `checkReplayCertificate`. |
| `ArbdProofs.sample_failed_certificate_check_bool` | `Proofs/CertificateExamples.lean` | medium | Evaluates the concrete failed certificate check to true. |
| `ArbdProofs.sample_failed_certificate_facts` | `Proofs/CertificateExamples.lean` | high | Instantiates the complete failed certificate fact package for the concrete opportunity failure. |
| `ArbdProofs.sample_failed_certificate_failure_record` | `Proofs/CertificateExamples.lean` | high | Computes the concrete failed certificate's plaintiff opportunity-failure record. |
...
| `ArbdProofs.second_opening_advances_to_arguments` | `Proofs/MeritsFlow.lean` |  |  |
| `ArbdProofs.setCouncilAnswers_preserves_phaseShape` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.setCouncilMembers_preserves_phaseShape` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.setPhase_preserves_answerIntegrity` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.setPhase_preserves_councilIdsUnique` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.stateWithCase_addFiling_preserves_caseFrameMatches` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.stateWithCase_appendEvidence_preserves_caseFrameMatches` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.stateWithCase_appendMaterials_preserves_caseFrameMatches` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.stateWithCase_preserves_caseFrameMatches` | `Proofs/ProcedureInvariants.lean` |  |  |
| `ArbdProofs.stateWithCase_preserves_phaseShape` | `Proofs/StepPreservation.lean` |  |  |
| `ArbdProofs.stateWithCase_preserves_recordIntegrity` | `Proofs/RecordIntegrity.lean` |  |  |
| `ArbdProofs.stateWithCase_setPhase_preserves_caseFrameMatches` | `Proofs/StepPreservation.lean` |  |  |
...
| `ArbdProofs.step_ok_meritsOffersUsePriorRecord` | `Proofs/RecordIntegrity.lean` | high | Shows that an accepted argument, rebuttal, or surrebuttal resolves offers against the source-state record. |
| `ArbdProofs.step_pass_phase_opportunity_record_result` | `Proofs/RecordIntegrity.lean` |  |  |
| `ArbdProofs.step_preserves_recordIntegrity` | `Proofs/RecordIntegrity.lean` | high | Shows that every accepted public step preserves record integrity. |
...
| `ArbdProofs.terminalFailedAccounted_of_status_failed` | `Proofs/CertificateFacts.lean` | medium | Shows that failed status yields a terminal next-opportunity result. |
...
| `ArbdProofs.validateSubmittedEvidenceEntry_ok` | `Proofs/RecordIntegrity.lean` | high | Turns successful submission validation into metadata, digest, freshness, size, and lineage facts. |
| `ArbdProofs.validateSubmittedEvidenceParent_ok` | `Proofs/RecordIntegrity.lean` | medium | Turns successful parent validation into an empty lineage or a prior matching commitment. |
| `ArbdProofs.validateTechnicalReportBatch_ok` | `Proofs/RecordIntegrity.lean` | medium | Turns successful report validation into UTF-8 title and summary byte-limit facts. |
