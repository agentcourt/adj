...
func runLocal(ctx context.Context, args []string, stdout io.Writer, stderr io.Writer) error {
	...
	plaintiffLawyerAuth := fs.String("plaintiff-lawyer-auth", "", "Plaintiff authentication: subscription or api-key; Pi requires api-key")
	...
	defendantLawyerAuth := fs.String("defendant-lawyer-auth", "", "Defendant authentication: subscription or api-key; Pi requires api-key")
