...
The plaintiff argues for the strongest supported higher score.  The defendant tests that position and argues for the strongest supported lower score or narrower range.  The council decides from the record.
