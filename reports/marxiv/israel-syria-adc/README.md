...
The [working LaTeX source](paper.tex) describes ADC, the shared model pool, jury selection, Lean procedure, and the Israel–Syria case under `adc/out/ex04-20260919-03/`.  The case remains in progress, and the report is an incomplete draft.  No ADC report has been submitted to marXiv.
